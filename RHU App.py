...
class AddLicenceeWindow(QDialog):
    ...
    def requirements_TabView(self):
        ...
        self.mentalHealthConditions = QComboBox()
        self.mentalHealthConditions.addItem("No mental health conditions")
        self.mentalHealthConditions.addItem("PTSD")
        self.mentalHealthConditions.addItem("Depression")
        self.mentalHealthConditions.addItem("Schizophrenic")
        self.mentalHealthConditions.addItem("Others")
        healthRequirementsLayout.addWidget(self.mentalHealthConditions)

        self.disabilityComboBox = QComboBox()
        self.disabilityComboBox.addItem("No disability")
        self.disabilityComboBox.addItem("Autism")
        self.disabilityComboBox.addItem("ADHD")
        self.disabilityComboBox.addItem("Dyslexia")
        self.disabilityComboBox.addItem("Blindness")
        self.disabilityComboBox.addItem("Others")

        accessibilityNote = QLineEdit()
        accessibilityNote.setPlaceholderText("Provide the accessibility notes here")
        healthRequirementsLayout.addWidget(self.disabilityComboBox)
...
class HomepageWindow(QMainWindow):
    ...
    def overview_TabView(self):
        ...
        self.data = [
            {'name': 'John Doe', 'ID': '284623'},
            {'name': 'Dustin', 'ID': '284624'},
            {'name': 'Johnathan', 'ID': '284625'},
            {'name': 'Hop', 'ID': '284626'},
            {'name': 'Anderson', 'ID': '221475'},
            {'name': 'Jim', 'ID': '284627'},
            {'name': 'Robin', 'ID': '284628'},
            {'name': 'Steve', 'ID': '284629'},
            {'name': 'Asher', 'ID': '284630'},
            {'name': 'Barbara', 'ID': '284631'},
            {'name': 'Will', 'ID': '284632'},
            {'name': 'Mike', 'ID': '284633'},
            {'name': 'Dustin', 'ID': '284634'},
            {'name': 'Johnathan', 'ID': '284635'},
            {'name': 'Hop', 'ID': '284636'},
            {'name': 'Keema', 'ID': '284637'},
            {'name': 'Powell', 'ID': '284638'},
            {'name': 'Howard', 'ID': '284639'},
            {'name': 'Christabel', 'ID': '284664'},
            {'name': 'Joseph', 'ID': '284665'},
            {'name': 'Muji', 'ID': '284666'},
            {'name': 'Lee', 'ID': '284667'},
        ]
    ...
    def RHU_TabView(self):
        ...
        self.data2 = [
            {'name': 'Durham County Hostel', 'capacity': '50'},
            {'name': 'Crook Hostel', 'capacity': '100'},
            {'name': 'Villa Grandview', 'capacity': '40'},
            {'name': 'Famosa Motel', 'capacity': '40'},
            {'name': 'Flakes Housing', 'capacity': '60'},
            {'name': 'Marisa Viewland', 'capacity': '75'},
            {'name': 'Hawkins High', 'capacity': '85'},
            {'name': 'Northumberland County Manor', 'capacity': '600'},
            {'name': 'Heinz Hotel', 'capacity': '50'},
            {'name': 'Karl Shared Housing', 'capacity': '40'},
            {'name': 'Zeiss Shared Housing', 'capacity': '30'},
            {'name': 'Mount Hostel', 'capacity': '50'},
            {'name': 'Elton Hostel', 'capacity': '50'},
        ]
