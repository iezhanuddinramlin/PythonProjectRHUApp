...
class AbstractAddNewEntry(QDialog):
    def __init__(self, firstTab, secondTab):
        super().__init__()
        ...
        self.firstTab = self.stackWidget.currentIndex()
...
class HomepageWindow(QMainWindow):
    ...
    def RHU_entry(self):
        housingEntry = QWidget(self)
        self.housingEntryLayout = QGridLayout(housingEntry)
...
class LoginWindow(QMainWindow):
    def __init__(self):
        ...
        self.loginPassword.setPlaceholderText("Password is durham2025")
